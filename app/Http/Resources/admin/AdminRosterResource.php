...
class AdminRosterResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            'color' => $this->roaster_status->color,
            'text_color' => $this->roaster_status->text_color,
            ...
            'shift_status' => $this->roaster_status->name,
